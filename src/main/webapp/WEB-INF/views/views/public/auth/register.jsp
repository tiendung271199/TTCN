...
<div class="main-content fl-right">
	<div class="section" id="detail-blog-wp">
		...
		<div class="section-detail">
			...
			<form action="${urlRegister}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<img id="preview-avatar" src="${contextPath}/images/user.png" style="width: 160px; height: 160px; border-radius: 50%" />
						</div>
					</div>
				</div>
				...
				<div style="margin-top: 10px; font-style: italic">
					<p>Bạn đã có tài khoản? <a href="${urlLogin}" title="Đăng ký tài khoản">Đăng nhập</a></p>
				</div>
			</form>
		</div>
	</div>
